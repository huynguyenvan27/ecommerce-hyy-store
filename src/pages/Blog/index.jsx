...
const Blog= () =>{
  ...
  return( 
    ...
    <div className="container">
      <div className="row">
        <button className="btn side-filter">DANH MỤC TIN TỨC</button>
        <div className="col-lg-3 col-md-12 col-sm-12 col-12 col" id="filter-product">
          ...
          <div className="news-filter">
            ...
            <Link to="/blog">Bộ sưu tập giày</Link>
            <Link to="/blog">Đánh giá giày</Link>
            <Link to="/blog">Phụ kiện phù hợp</Link>
            <Link to="/blog">Deal đồng giá</Link>
          </div>
        </div>        
        <div className="col-lg-9 col-md-12 col-sm-12 col-12 col news-list">
          ...
          <div className="news-block d-flex justify-content-between">
            ...
            <div className="news-info">
              <Link to="/blog" className="name-news">6 Facts ngắn về Air Jordan 4 “Bred” ra mắt vào
                cuối tuần này</Link>
              <span className="news-tag">Ngày viết:</span>
              <span className="news-time-public">
                27/12/2021
          ...
          <div className="news-block d-flex justify-content-between">
            ...
            <div className="news-info">
              <Link to="/blog" className="name-news">Đánh giá - ASICS GEL-Nimbus 22</Link>
              <span className="news-tag">Ngày viết:</span>
              <span className="news-time-public">
                27/12/2021
              </span>
          ...
          <div className="news-block d-flex justify-content-between">
            ...
            <div className="news-info">
              <Link to="/blog" className="name-news">Fragment design x Travis Scott x Air Jordan 1 High - hình ảnh chính thức!</Link>
              <span className="news-tag">Ngày viết:</span>
              <span className="news-time-public">
                27/12/2021
              </span>
          ...
          <div className="news-block d-flex justify-content-between">
            ...
            <div className="news-info">
              <Link to="/blog" className="name-news">Cách chọn giày chính xác khi mua giày online</Link>
              <span className="news-tag">Ngày viết:</span>
              <span className="news-time-public">
                27/12/2021
              </span>
